...
int main(){
	...
	printf("%s\n",c);
	//Part 1 - 2 points
	//write a function joinrev that takes 2 strings and returns a 3rd string that is the first string followed by the 2nd string reversed
	//Output should be:
	//Hello dlroW
	...
	//The first argument is a binary file of type produced in part 3. The function will read it in,  normalize a, and print out to the text 
	...
	//The first argument is the text file of type produced in part 4.  Read in the line using fgets or fread. Either use realloc or check for the size 
	//of the file using fseek, ftell to allocate enough space to store the line. Then use strtok to parse the file. Print the results out to a binary file 
	//in the same format as the binary file produced in part 3. Remember to free the memory.
